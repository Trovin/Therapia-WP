    ...
    <div class="container">
        <div class="page-header__row">
            <div class="desktop-logo">
                <a href="<?php echo get_home_url(); ?>" class="logo-link" rel="home">
                    ...
                    <nav class="social">
                        <ul class="social__list">
                            <li class="social__item">
                                <a href="<?php the_field('facebook_link', 'option'); ?>" class="social__link social__link_cat">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                            <li class="social__item">
                                <a href="<?php the_field('twitter_link', 'option'); ?>" class="social__link social__link_cat">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            </li>
                            <li class="social__item">
                                <a href="<?php the_field('instagramm_link', 'option'); ?>" class="social__link social__link_cat">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li class="social__item">
                                <a href="<?php the_field('pinterest_link', 'option'); ?>" class="social__link social__link_cat">
